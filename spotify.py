...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        sys.exit()
    # OPTION 1: tracks_by_time(username,50) for your recent tracks by time of day
	# OPTION 2: read_dailyMix(username) to view stats about your daily mix playlist
	# OPTION 3: run my_top_tracks(username,50) to see your most played songs
    tracks_by_time(username,50)
